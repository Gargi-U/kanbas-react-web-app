...
export default function Lab2() {
  ...
  <div className="wd-pos-relative">
    ...
    <div>
      ...
      <img className="wd-float-right"
        src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" alt="Starship in flight"/>
  ...
  <div className="table-responsive">
    ...
    <div id="wd-css-navigating-with-cards">
      ...
      <img src="images/stacked.jpg" alt="shinchan" className="card-img-top" />
